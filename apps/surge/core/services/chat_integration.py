"""Chat Integration Service for Surge Platform
...
class ChatIntegrationService(BaseService):
    ...
    async def initialize_chatwoot(self) -> bool:
        ...
        try:
            ...
            logger.exception(f"Failed to initialize Chatwoot: {e!s}")
            return False
    ...
    async def initialize_discord(self) -> bool:
        ...
        try:
            ...
            if self.discord_config["webhook_url"]:
                test_payload = {
                    "content": "🔧 Surge chat integration initialized",
                    "embeds": [
                        {
                            "title": "System Status",
            ...
            logger.exception(f"Failed to initialize Discord: {e!s}")
            return False
    ...
    async def send_chatwoot_message(
        ...
        try:
            ...
            logger.exception(f"Chatwoot message error: {e!s}")
            return {"error": str(e)}
    ...
    async def send_discord_message(
        ...
        try:
            ...
            logger.exception(f"Discord message error: {e!s}")
            return {"error": str(e)}
    ...
    async def create_discord_invite(
        ...
        try:
            ...
            logger.exception(f"Discord invite creation error: {e!s}")
            return None
    ...
    async def get_chat_stats(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to get Chatwoot stats: {e!s}")
        ...
        try:
            ...
            logger.exception(f"Failed to get Discord stats: {e!s}")
