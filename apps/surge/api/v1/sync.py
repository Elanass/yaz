    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Error creating sync job: {e!s}",
        )
...
async def list_sync_jobs(
    status: SyncStatus | None = Query(None, description="Filter by job status"),
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error retrieving sync jobs: {e!s}",
        )
...
async def get_sync_job(
    job_id: str, sync_service: SyncService = Depends(get_sync_service)
):
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error retrieving sync job: {e!s}",
        )
...
async def cancel_sync_job(
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error cancelling sync job: {e!s}",
        )
...
async def create_message(
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error creating message: {e!s}",
        )
...
async def list_messages(
    recipient_id: str | None = Query(None, description="Filter by recipient ID"),
    type: MessageType | None = Query(None, description="Filter by message type"),
    ...
    **Response:**
    ...
    """
    try:
        return await sync_service.list_messages(
            recipient_id=recipient_id, type=type, status=status, page=page, limit=limit
        )

    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error retrieving messages: {e!s}",
        )
...
async def get_message(
    message_id: str, sync_service: SyncService = Depends(get_sync_service)
):
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error retrieving message: {e!s}",
        )
...
async def mark_message_read(
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error marking message as read: {e!s}",
        )
...
async def delete_message(
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error deleting message: {e!s}",
        )
...
async def get_sync_status(
    resource_type: str,
    resource_id: str | None = Query(None, description="Specific resource ID"),
    sync_service: SyncService = Depends(get_sync_service),
):
    ...
    **Response:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error retrieving sync status: {e!s}",
        )
