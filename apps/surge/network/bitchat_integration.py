...
class SurgifyMessageHandler:
    ...
    def send_medical_data(self, destination: str, data: dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.exception(f"Failed to send medical data: {e}")
            return False
    ...
    def sync_offline_messages(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.exception(f"Failed to sync offline messages: {e}")
            return []
...
surgify_handler: SurgifyMessageHandler | None = None
...
def get_surgify_handler() -> SurgifyMessageHandler | None:
