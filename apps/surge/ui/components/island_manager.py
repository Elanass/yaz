...
class IslandManager:
    ...
    def _initialize_default_islands(self) -> None:
    ...
    def register_island(self, island_id: str, config: dict) -> None:
    ...
    def get_island_config(self, island_id: str) -> dict | None:
    ...
    def get_island_html(
        self, island_id: str, container_id: str, options: dict | None = None
    ) -> str:
    ...
    def create_feedback_island(
        self, container_id: str, options: dict | None = None
    ) -> str:
    ...
    def create_discussion_island(
        self, container_id: str, case_id: str | None = None, options: dict | None = None
    ) -> str:
...
def render_feedback_island(container_id: str, options: dict | None = None) -> str:
...
def render_discussion_island(
    container_id: str, case_id: str | None = None, options: dict | None = None
) -> str:
