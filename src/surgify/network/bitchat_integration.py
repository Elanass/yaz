...
class SurgifyMessageHandler:
    ...
    def __init__(self, node_id: str):
        ...
        self.encryption_key = f"surgify_{node_id}_key"  # In production, use proper key management
    ...
    def send_case_consultation(self, destination: str, case_id: str, consultation_data: Dict[str, Any]) -> bool:
            ...
            for msg in offline_messages:
                if msg.get('message_type') == 'medical_data':
                    ...
                    if success:
                        ...
                        logger.info(f"Successfully resent message to {msg['destination']}")
                    else:
    ...
    def _is_valid_surgify_message(self, message: Dict[str, Any]) -> bool:
        ...
        required_fields = ['type', 'from', 'to', 'timestamp', 'data', 'protocol_version']
