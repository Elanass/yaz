...
class IslandManager:
    ...
    def _initialize_default_islands(self):
        ...
        self.register_island('interaction', {
        ...
        self.register_island('discussion', {
        ...
        self.register_island('comparison', {
    ...
    def get_island_html(self, island_id: str, container_id: str, options: Dict = None) -> str:
    ...
    def get_island_script_tags(self, island_ids: List[str]) -> str:
        ...
        for island_id in island_ids:
            ...
            if config and config['component_path'] not in loaded_paths:
                script_tags.append(f'<script src="{config["component_path"]}"></script>')
    ...
    def create_discussion_island(self, container_id: str, case_id: str = None, options: Dict = None) -> str:
...
def render_discussion_island(container_id: str, case_id: str = None, options: Dict = None) -> str:
