...
async def create_deliverable(
    ...
    **Response:**
    ...
    """
    try:
        deliverable = await deliverable_service.create_deliverable(request, current_user.username)
...
async def list_deliverables(
    type: Optional[DeliverableType] = Query(None, description="Filter by deliverable type"),
...
async def download_deliverable(
    ...
    **File Formats:**
    ...
    try:
        ...
        content_type = content_type_map.get(deliverable.format.lower(), "application/octet-stream")
