...
def upgrade():
    ...
    op.create_index(op.f('ix_text_entries_patient_id'), 'text_entries', ['patient_id'], unique=False)
    op.create_index(op.f('ix_text_entries_case_id'), 'text_entries', ['case_id'], unique=False)
    op.create_index(op.f('ix_text_entries_created_at'), 'text_entries', ['created_at'], unique=False)
    ...
    op.create_index(op.f('ix_media_files_patient_id'), 'media_files', ['patient_id'], unique=False)
    op.create_index(op.f('ix_media_files_case_id'), 'media_files', ['case_id'], unique=False)
