...
class BackwardCompatibilityTester:
    ...
    def test_existing_api_endpoints(self):
        ...
        for endpoint in endpoints_to_test:
            try:
                ...
                assert response.status_code in [200, 404, 422], f"Unexpected status {response.status_code} for {endpoint}"
    ...
    def test_research_enhancements_optional(self):
        ...
        try:
            ...
            raise AssertionError(f"Research enhancements not properly optional: {str(e)}")
