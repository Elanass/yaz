...
class TestOfflineCRDTBasics:
    ...
    def test_crdt_set_operation(self):
        ...
        op = self.node1.set("case_123", {"title": "Emergency Surgery", "status": "active"})
...
class TestOfflineSyncScenarios:
    ...
    def test_offline_case_creation_scenario(self):
        ...
        self.mobile_node1.set("case_001", {
        ...
        self.mobile_node1.set("case_002", {
        ...
        self.mobile_node2.set("case_003", {
            "title": "Hernia Repair",
            "patient_id": "P003", 
            "status": "completed",
            "created_by": "doctor2",
    ...
    def test_offline_case_update_scenario(self):
        ...
        self.mobile_node1.set("case_shared", {
            "title": "Surgical Case",
            "status": "in_progress",
        ...
        self.mobile_node2.set("case_shared", {
    ...
    async def test_concurrent_operations_performance(self):
        ...
        async def create_operations(node, node_id, num_ops):
            for i in range(num_ops):
                node.set(f"case_{node_id}_{i}", {
                    "title": f"Case {i} from Node {node_id}",
                    "status": "active"
                })
